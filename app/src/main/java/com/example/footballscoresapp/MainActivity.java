...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private final String gameStatusScheduled = "SCHEDULED,LIVE,IN_PLAY,PAUSED";
    private final String gameStatusFinished = "FINISHED,CANCELLED";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if( savedInstanceState != null) {
            ...
            gameStatus = savedInstanceState.getString("GAME_STATUS", gameStatusScheduled);
